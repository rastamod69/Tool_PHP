...
class rst {
	...
	static function importColor() {
		if( PHP_OS_FAMILY == "Linux" ){
			...
			define("bl","\033[1;40;30m");
			define("bk","\033[1;43;33m");
			define("bp","\033[1;47;37m");
			define("h0","\033[0;32m");
			define("o","\033[0m");
		} else {
			define("n","\n");
	...
	static function _checkversion() {
		$server = json_decode(file_get_contents("https://raw.githubusercontent.com/rastamod69/TooL_PHP/main/App/setup.json"),1);
